...
def get_hyperparameters(model_name):
    ...
    It currently supports hyperparameters for 'resnet34' and 'tiny_vit_21m' models.
    ...
    if model_name.startswith("resnet34"):
        # After 50 trials: 0.628
        # Trial 11 finished with value: 0.628 and parameters: {'learning_rate': 0.00595188208937121, 'batch_size': 16, 'optimizer': 'SGD', 'weight_decay': 0.0006420993208725044, 'scheduler': 'ReduceLROnPlateau'}. Best is trial 11 with value: 0.628.
        return {
            "learning_rate": 0.00595188208937121,
            "weight_decay": 0.0006420993208725044,
            "batch_size": 16,
            "scheduler": "ReduceLROnPlateau",
            "optimizer": "SGD",
            "hyper_tunning_acc": "628",
        }

    if model_name.startswith("tiny_vit_21m"):
        # After 50 trials: 0.6045
        # Trial 3 finished with value: 0.6045 and parameters: {'learning_rate': 0.0003087571957548278, 'batch_size': 32, 'optimizer': 'Adam', 'weight_decay': 0.00014492583870870016, 'scheduler': 'ReduceLROnPlateau'}
        return {
            "learning_rate": 0.0003087571957548278,
            "weight_decay": 0.00014492583870870016,
            "batch_size": 32,
            "scheduler": "ReduceLROnPlateau",
            "optimizer": "Adam",
            "hyper_tunning_acc": "6045",
        }
...
if __name__ == "__main__":
    ...
    # train_model('tiny_vit_21m_224', pretrained=PRETRAINED)
    # train_model('resnet34d', pretrained=PRETRAINED)
